...
MODULE_HEADER = _('Header')
MODULE_CONTENT = _('Content')
MODULE_FOOTER = _('Footer')
...
class IndustriesTeaserPlugin(CMSPluginBase):
    ...
    cache = False
    icon = 'cms-icon cms-icon-list-ol'
...
class QuickContactFormPlugin(CMSPluginBase):
    ...
    cache = False
    icon = 'cms-icon cms-icon-comment'
...
class SubCategoriesGridPlugin(CMSPluginBase):
    ...
    cache = False
    icon = 'cms-icon cms-icon-sitemap'
...
class SolutionItemPlugin(CMSPluginBase):
    ...
    cache = False
    icon = 'cms-icon cms-icon-check-circle'
