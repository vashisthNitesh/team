"""
Django settings for patient_cms project.

Generated by 'djangocms' command using django CMS 5.0.5 and Django 6.0.2.
...
SECRET_KEY = 'django-insecure-_)mb02ed&mor530xj$_v72(@qnlug#x$6y2b%nl32bcdb=z#&1'
...
ROOT_URLCONF = 'patient_cms.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "patient_cms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'patient_cms.wsgi.application'
